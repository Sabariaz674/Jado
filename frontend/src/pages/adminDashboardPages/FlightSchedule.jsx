  ...
  return (
    ...
    <div className="py-6 px-4 sm:py-12 sm:px-6 flex justify-center items-center">
      <div className="w-full max-w-7xl">
        <h1 className="text-2xl sm:text-4xl font-bold text-[#1e3a8a] mb-4 sm:mb-6 ml-10">
          Flight Schedule
        </h1>
        ...
        <div className="flex justify-end mb-4 sm:mb-6">
          <button
            ...
            className="bg-[#1e3a8a] hover:bg-[#152960] transition-colors duration-300 text-white font-bold py-2 px-4 sm:py-3 sm:px-6 rounded-md shadow-lg text-sm sm:text-base mr-9"
          >
            Add New Flight
          </button>
        </div>
